...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_Return, spawn,          SHCMD("urxvt -e tmux new-session -A -s default") },
	{ MODKEY|ControlMask,           XK_c,      spawn,          SHCMD("urxvt -e tty-clock -csC4") },
	{ MODKEY|ControlMask,           XK_h,      spawn,          SHCMD("urxvt -e htop") },
	{ MODKEY|ControlMask,           XK_q,      spawn,          SHCMD("urxvt -e qalc") },
	{ MODKEY|ControlMask,           XK_f,      spawn,          SHCMD("urxvt -e rover") },
